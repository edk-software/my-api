...
exports.getSearch= async function(req, res) {
    await edkSearchDao.getEdkSearch(req.query.territoryId, req.query.editionId, req.query.areaId, req.query.eventDate, req.query.orderByName,  req.query.search, function (result) {
